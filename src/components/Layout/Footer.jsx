...
import { Facebook, Instagram, Twitter, Mail, MapPin, Youtube } from 'lucide-react';
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                    <div>
                        ...
                        <div className="flex space-x-4">
                            <a href="#" className="text-gray-400 hover:text-halcones-blue transition-colors"><Facebook size={20} /></a>
                            ...
                            <a href="#" className="text-gray-400 hover:text-halcones-blue transition-colors"><Twitter size={20} /></a>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-gray-400 text-sm">
                            <li className="flex items-center"><MapPin size={16} className="mr-2 text-halcones-blue" /> Ciudad Deportiva de Torrevieja</li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-gray-400 text-sm">
                            <li><a href="/equipos" className="hover:text-halcones-blue transition-colors">Equipos</a></li>
                            <li><a href="/calendario" className="hover:text-halcones-blue transition-colors">Calendario</a></li>
                            <li><a href="/merchandising" className="hover:text-halcones-blue transition-colors">Tienda</a></li>
                        </ul>
                    </div>
                </div>
